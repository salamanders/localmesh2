...
object HealingMesh : MeshConnection.MeshConnectionListener {
    ...
    override fun onFailedConnection(endpointId: String) {
        Timber.w("FAILURE for $endpointId")
    }
     ...
     */
    override fun onPayloadReceived(endpointId: String, message: NetworkMessage) {
